...
iter_max = 80  # Maximum number of iterations to be done
# no of control points + [overhang,gap] + [deflection angle,fitness]
CHROMOSOME_SIZE = 8 + 2
change = 3
#design space
max_w=(15-1.85)*0.0025
min_w=(3.4-1.85)*0.0025
max_d=(3.85-3.5)*0.0025
min_d=(3.85+4)*0.0025
...
cu_file=r"/home/fmg/OpenFOAM/fmg-6/run/Airfoil/curves/"
cfd_call="/home/fmg/OpenFOAM/fmg-6/run/Airfoil/cfd_openfoam/Allrun"
gcost="/home/fmg/OpenFOAM/fmg-6/run/Airfoil/simvalue/CP%i/forceCoeffs.dat"
