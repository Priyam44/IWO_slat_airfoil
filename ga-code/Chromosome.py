class Chromosome:
        ...
        if(mode == "initialise"):
            ...
            while (not flag):
                ...
                if(slopec.slope_checker(lower, upper)):
                    ...
                    curve = self.profile_gen()                      # generating slat coordinates
                    Chromosome.genstl(curve,cfdstl)                 # creating stl file of slat
                    time  = self.cal_cost()                         # Running CFD simulation
                    print("TIME TAKEN:",time," mins")
                    
                    temp  = self.get_cost()                         #Obtaining Cl and Cd
                    if(temp==False):
                        flag = False
                    else:
    ...
    def profile_gen(self):
        ...
        """Generates Coordinates of Transformed Slats"""
    ...
    def transform_slat(target, gap, overhang, deflection, lead, trail,cpoints):
        ...
        """Transforms slat to required orientation"""
    ...
    def divide_cpoints(self):
        ...
        """Divide Points for upper and lower surface"""
